# Query pack — TGA DAEN — Australia

Load (DuckDB reads .gz directly): `CREATE VIEW v AS SELECT * FROM read_csv_auto('data/tga_daen_all_69col.csv.gz', header=true, all_varchar=true);`
