# TGA DAEN — Australia — open dataset + query kit

A clean, searchable copy of Therapeutic Goods Administration (TGA) adverse-event data (Australia), in the
...
**Scope:** COVID vaccines + non-COVID vaccines + all medicines; product-classified in gn_spare.
**Rows:** 250,903. Each row is one adverse-event report.
**Product classes (`gn_spare`):** covid_vaccine (155,090), non_vaccine (64,998), vaccine_other (30,815).
