# Query pack — Canada Vigilance (CVAR) — vaccines

Load (DuckDB reads .gz directly): `CREATE VIEW v AS SELECT * FROM read_csv_auto('data/cvar_vaccine_1965_2026_69col.csv.gz', header=true, all_varchar=true);`
